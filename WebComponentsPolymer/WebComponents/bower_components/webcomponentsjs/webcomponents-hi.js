(function () {
  ...
  */
  ...
  (function (m) {
    ...
    function v(a) {
      var b = document.querySelectorAll('link[rel=import]:not(import-dependency)'),
        c = b.length;
      if (c) for (var d = 0, e = b.length, h; d < e && (h = b[d]); d++) w(h, function () {
        --c || a();
      }); else a();
    }
    ...
    var G = /(^\/)|(^#)|(^[\w-\d]*:)/, H = /(url\()([^)]*)(\))/g, I = /(@import[\s]+(?!url\())([^;]*)(;)/g, J = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, f = {
      A: function (a, b) {
    ...
    l.prototype.o = function (a) {
      ...
      } else this.c++, this.b[c] = 'pending', D.load(c, function (a, d) {
        a = b.D(a, d || c);
        b.b[c] = a;
        b.c--;
        b.f(a);
    ...
    l.prototype.F = function (a) {
      function b(e) {
        if (e < d) {
          ...
          f; x++) g.setAttribute(h.attributes[x].name, h.attributes[x].value);
          B = g;
    ...
    l.prototype.G = function (a) {
      ...
      if (c) for (var d = A && !!document.querySelector('link[rel=stylesheet][href][type=import-disable]'), e = {}, h = 0, g = b.length; h < g && (e.a = b[h]); e = { a: e.a },
        h++) {
        if (w(e.a, function (b) {
          return function () {
    ...
    if (z) {
      for (var r = document.querySelectorAll('link[rel=import]'), C = 0,
             K = r.length, y; C < K && (y = r[C]); C++) y.import && 'loading' === y.import.readyState || (y.__loaded = !0);
      r = function (a) {
        a = a.target;
        u(a) && (a.__loaded = !0);
      };
    ...
    p(function () {
      return document.dispatchEvent(n('HTMLImportsLoaded', { cancelable: !0, bubbles: !0, detail: void 0 }));
    });
    m.useNative = z;
    m.whenReady = p;
  ...
  (function () {
    var m = window.customElements, n = window.HTMLImports;
